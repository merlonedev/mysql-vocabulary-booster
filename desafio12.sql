-- Faça um relatório que lista todas as pessoas funcionárias que possuem o mesmo cargo (banco hr).
...
-- e em segundo lugar pela coluna "Nome completo funcionário 2" em ordem alfabética.
SELECT 
...
FROM hr.employees AS t1
	INNER JOIN
hr.employees AS t2 ON t1.JOB_ID = t2.JOB_ID AND t1.EMPLOYEE_ID <> t2.EMPLOYEE_ID
ORDER BY 1, 4;
