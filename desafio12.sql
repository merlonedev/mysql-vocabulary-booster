SELECT 
    ...
    CONCAT(employee2.FIRST_NAME,
            ' ',
            employee2.LAST_NAME) AS 'Nome completo funcionário 2',
...
WHERE
    employee1.JOB_ID = employee2.JOB_ID
        AND CONCAT(employee1.FIRST_NAME,
            ' ',
            employee1.LAST_NAME) <> CONCAT(employee2.FIRST_NAME,
            ' ',
            employee2.LAST_NAME)
ORDER BY CONCAT(employee1.FIRST_NAME,
        ' ',
        employee1.LAST_NAME) ASC , CONCAT(employee2.FIRST_NAME,
        ' ',
        employee2.LAST_NAME) ASC;
