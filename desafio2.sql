...
-- A segunda deve possuir o alias "Nível" e exibir o nível de remuneração do cargo com base no seu salário máximo,
-- categorizando os níveis de remuneração da seguinte forma:
