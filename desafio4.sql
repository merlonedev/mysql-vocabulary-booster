...
FROM jobs AS jobs INNER JOIN employees AS employees ON jobs.JOB_ID = employees.JOB_ID
GROUP BY jobs.JOB_ID ORDER BY ROUND(AVG(employees.SALARY), 2) ASC , jobs.JOB_TITLE ASC;
